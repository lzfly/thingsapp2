...
public class ActionLinkDeviceActivity extends ActionBarActivity implements OnClickListener{
    private final static String TAG = "ActionLinkDeviceActivity";
	...
	private void init(){
        ...
        actionBar.setTitle(R.string.link_device_trigger_action);
		...
		triggerAttrlListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(getApplicationContext(), ActionDeviceAttrActivity.class);
